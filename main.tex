...
\begin{figure}
\begin{center}
\includegraphics[scale=0.35]{\string"uw plane dashed\string".png}\caption{\label{fig:pp}A typical trajectory corresponds to an approximate traveling
wave.}
\end{center}
\end{figure}
...
REFERENCES SHOULD BE CONSISTENT IN STYLE.
