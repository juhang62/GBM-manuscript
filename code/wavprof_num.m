function [wid,lwid,spd,peak]=wavprof_num(dx,difft,U1,U2)
% U1=U1/max(U1);
% U2=U2/max(U2);
...
%     slp=NaN;
% else
    lastind=find(U1>maxU1*0.8,1,'last');
    wid=(lastind-find(U1>maxU1*0.8,1,'first'))*dx;
    lowind=find(U1>maxU1*0.2,1,'last');
